        ...
        <section class="bg-right stats">
            <div class="row justify-content-center align-items-center">
                <div class="wrapp">
                    ...
                    <div class="content col-xl-10 col-lg-10 col-md-12 col-sm-12">
        ...
        <div class="charts">
            <div class="row">
                <div class="wrapp col-12">
                    <div class="content">
                        <div class="chart d-xl-flex d-lg-flex d-md-block d-sm-block justify-content-center">
                            <div class="chart_img col-xl-6 col-lg-6 col-md-12 col-sm-12">

                                <img style="z-index: 1000; position: relative; margin: 0px;" width="100%" src="assets/figma.jpg" alt="">
                            </div>
                        ...
                        <div class="chart d-xl-flex d-lg-flex d-md-block d-sm-block justify-content-center align-items-center">
                            ...
                            <div class="chart_img img-second col-xl-6 col-lg-6 col-md-12 col-sm-12">
