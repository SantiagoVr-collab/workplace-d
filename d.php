...
<body>
    <div class="container">
        ...
        <section class="main">
            <div class="row">
                <div class="wrapp d-flex justify-content-center align-items-center">
                    <div class="content">
                        <div class="title">
                            <h1>A modern design system for your new <span class="underlined-text">SaaS platform.</span></h1>
                        </div>
                        ...
                        <div class="row buttons mt-5">
                            <div class="join col-6 d-flex justify-content-end">
                                <a class="default_btn join_style_btn" href="">join us</a>
                            </div>
        ...
        <section class="bg-right stats">
            <div class="row justify-content-center align-items-center">
                <div class="wrapp">
                </div>
                    <div class="content col-10">
                        <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, quas distinctio! Maxime id sunt placeat pariatur, ut corrupti doloribus rem architecto distinctio nisi magnam. Eaque nam labore facere ipsum eum.</p>
                    
                        <div class="video col-12 mt-5 d-flex justify-content-center">
                            <video class="main_video" style="width: 100%; border-radius: 5px;" src="assets/tomi7-la-computadora-para-maestros.mp4" ></video>
                        </div> -->

                        <div class="sector d-flex">
                        <div class="content-sector col-6">
                        ...
                        <div class="content-chart col-12 d-flex">
        ...
        <div class="charts">
            <div class="row">
                <div class="wrapp col-12">
                    <div class="content">
                        <div class="chart d-flex justify-content-center">
                            <div class="chart_img col-6">

                                <img style="z-index: 1000; position: relative;" width="100%" src="assets/figma.jpg" alt="">
                            </div>

                            <div class="chart_content col-6">
                        ...
                        <div class="chart d-flex justify-content-center align-items-center">
                            <div class="chart_content col-6">
                                ...
                                <ul>
                                    ...
                                    <div class="bar-lighter"></div>
                                    </div></li>
                                </ul>
                            </div>
                            <div class="chart_img col-6" style="padding: 120px;">

                                <img class="d-flex justify-content-center" style="z-index: 1000; position: relative;" width="100%" src="assets/screenshot-2.jpg" alt="">
                            </div>
